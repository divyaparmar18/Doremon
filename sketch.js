var bluecapImg, balloon_redImg, yellowcapImg, redcapImg;
...
function preload() {
    bluecapImg = loadImage("Doraemon_blue.png");
    yellowcapImg = loadImage("Doraemon_yellow.png");
    redcapImg = loadImage("Doraemon_red.png");
...
function setup() {
    ...
    shape.addImage("shape", bluecapImg);
...
function draw() {
    ...
    if (gameState === "start") {
        var shape_cap_color = [bluecapImg, redcapImg, yellowcapImg];
